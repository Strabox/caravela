...
type DiscoveryInternal interface {
	...
	FindOffers(resources resources.Resources) []remote.Offer // Find a list of offers for a given resource combination
	ObtainResources(offerID int64,
		necessaryResources resources.Resources) bool // Obtain a resource offer to submit a container
