...
func TestNewContainer(t *testing.T) {
	...
	resources := *resources.NewResources(cpusTest, ramTest)
	container := NewContainer(containerNameTest, imageKeyTest, args, portMaps, resources, containerIDTest)
	...
	assert.Equal(t, resources, container.Resources(), "Container's resources is incorrect!")
